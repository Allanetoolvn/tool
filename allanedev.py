# -*- coding: utf-8 -*- 
 ...
     stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Copyright : Nguyễn Mạc Khánh    "+Fore.LIGHTGREEN_EX  +" ║\n") 
     stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Zalo Contact : 0961680340  "+Fore.LIGHTGREEN_EX  +"                  ║\n") 
 ...
 ############################################################################################## 
 def command(): 
     stdout.write(Fore.LIGHTGREEN_EX+"╔═══"+Fore.LIGHTGREEN_EX+"[""Admin"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTGREEN_EX+"Callmeallane"+Fore.CYAN+"]"+Fore.LIGHTGREEN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE) 
     command = input() 
